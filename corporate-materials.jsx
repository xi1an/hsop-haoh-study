        ...
        name: {
          groups: [
            ...
            },
            {
              ...
              icon: 'seal',
              items: [
                { text: '旧预留印鉴', note: '旧企业公章、旧财务章' },
                { text: '新预留印鉴', note: '新企业公章、新财务章' },
                { text: '法定代表人名章' },
                { text: '旧章缴销证明', note: '旧企业公章、旧财务章无法提供的，需提供对应缴销证明' },
        ...
        nameAndLegal: {
          groups: [
            ...
            },
            {
              ...
              icon: 'seal',
              items: [
                { text: '旧预留印鉴', note: '旧企业公章、旧财务章、旧法人章' },
                { text: '新预留印鉴', note: '新企业公章、新财务章、新法人章' },
                { text: '旧章缴销证明', note: '旧企业公章、旧财务章、旧法人章均无法提供的，需提供对应缴销证明' },
                { text: '印章遗失登报证明', note: '旧章遗失无法提供的，需提供市级以上报纸登报遗失声明；可在支付宝首页搜索“登报点点”自行登报' },
              ],
            },
          ],
          ...
          groups: [
            {
              ...
              items: [
                { text: '法人资格登记证书正本原件及复印件2份', note: '复印件请使用A4纸' },
                { text: '开户许可证或基本存款账户信息' },
                { text: '法定代表人或负责人有效身份证件原件', note: '单位名称变更但法定代表人或负责人未变更时仍需携带' },
                { text: '经办人有效身份证件原件', note: '委托经办人办理时提供' },
                { text: '单位公章' },
                { text: '财务专用章' },
                { text: '法定代表人或负责人名章' },
        ...
        legalPerson: {
          groups: [
            ...
            },
            {
              ...
              icon: 'seal',
              items: [
                { text: '单位公章', note: '负责人变更但单位名称未变更时仍需携带' },
                { text: '财务专用章', note: '负责人变更但单位名称未变更时仍需携带' },
